...
import type * as ReturnTypes from '../types-returns/my_psp22_metadata';
...
import DATA_TYPE_DESCRIPTIONS from '../data/my_psp22_metadata.json';
import EVENT_DATA_TYPE_DESCRIPTIONS from '../event-data/my_psp22_metadata.json';
